                ...
                <div class="container">
                        <div class="row">
                                ...
                                <div id="bodyupit" class="col-md-2">
                                        <form>
                                                <div class="form-group"><label
                                                                for="exampleInputPassword1">Težina</label><input
                                                                type="text" class="form-control" id="exampleInputezina"
                                                                placeholder=""></div>
                                                <div class="form-group"><label
                                                                for="exampleInputPassword1">Visina</label><input
                                                                type="text" class="form-control" id="exampleInputezina"
                                                                placeholder=""></div>
                                                <div class="form-group"><label for="exampleInputPassword1">Opseg
                                                                vrata</label><input type="text" class="form-control"
                                                                id="exampleInputezina" placeholder=""></div>
                                                <div class="form-group"><label for="exampleInputPassword1">Opseg
                                                                struka</label><input type="text" class="form-control"
                                                                id="exampleInputezina" placeholder=""></div>
                                                <div class="form-group"><label for="exampleInputPassword1">Opseg
                                                                kukova</label><input type="text" class="form-control"
                                                                id="exampleInputezina" placeholder=""></div><button
                                ...
                                <div id="bodyuotput" class="col-9">
                                        <p10><strong>BODY SURFACE AREA</strong></p10>
                                        <div id="korisnik" class="form-row">
                                                <div class="form-group col-md-4"><label for="inputEmail4">Du Boisova
                                                                metoda</label><input type="email" class="form-control"
                                                                id="inputEmail4" placeholder=""></div>
                                                <div class="form-group col-md-4"><label for="inputEmail4">Takahirina
                                                                metoda</label><input type="email" class="form-control"
                                                                id="inputEmail4" placeholder=""></div>
                                                <div class="form-group col-md-4"><label for="inputEmail4">Boydova
                                                                metoda</label><input type="email" class="form-control"
                                                                id="inputEmail4" placeholder=""></div>
                                        </div>
                                        ...
                                        <div id="korisnik" class="form-row">
                                                <div class="form-group col-md-4"><label for="inputEmail4">Body fat
                                                                index</label><input type="email" class="form-control"
                                                                id="inputEmail4" placeholder=""></div>
                                                ...
                                                <div class="form-group col-md-4"><label for="inputEmail4">Body fat
                                                                mass</label><input type="email" class="form-control"
                                                                id="inputEmail4" placeholder=""></div>
                                                <div class="form-group col-md-4"><label for="inputEmail4">Čista tjelesna
                                                                masa</label><input type="email" class="form-control"
                                                                id="inputEmail4" placeholder=""></div>
                                                <div class="form-group col-md-4"><label for="inputEmail4">Body fat
                                                                mass</label><input type="email" class="form-control"
                                                                id="inputEmail4" placeholder=""></div>
                                        ...
                                        <div id="korisnik" class="form-row">
                                                <div class="form-group col-md-4"><label for="inputEmail4">Energija
                                                                (kJ)</label><input type="email" class="form-control"
                                                                id="inputEmail4" placeholder=""></div>
                                                <div class="form-group col-md-4"><label for="inputEmail4">Energija
                                                                (kcal)</label><input type="email" class="form-control"
                                                                id="inputEmail4" placeholder=""></div>
                                                <div class="form-group col-md-4"><label
